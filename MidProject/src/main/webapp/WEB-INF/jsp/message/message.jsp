...
<body>
  <div id="container">
    <header>
      <h1>메시지함</h1>
      <button onclick="openMenu()" id="btn1">
    ...
    <nav>
      <div id="condition1" onclick="openAllMs()">메시지</div>
      <div id="condition2" onclick="openSaveMs()">보관처리됨</div>
      <div id="condition3" onclick="openNotReadMs()">읽지않음</div>
