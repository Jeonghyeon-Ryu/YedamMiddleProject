...
<template id="ex-template" style="display:none">
   <div class="ex-container">
      <div class="ex-img">
         <img src="">
      </div>   
      <div class="ex-content">
      		<div class="ex-content-left">
		         <div class="ex-title"></div>
		         <div class="ex-address"></div>
		         <div >체크인 : <span class="ex-checkIn"></span></div>
		         <div >체크아웃 :<span class="ex-checkOut"></span></div>
	    	</div>
	         <div class=ex-flex>
		         <div class="ex-memberName"></div>
		         <div class="ex-phone"></div>
		         <div class="ex-price"></div>
	         </div>
      </div>
   </div>
</template>
